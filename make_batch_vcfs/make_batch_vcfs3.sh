...
CELLSNP_VCF=/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/cellsnp/batch3/TBSS09/cellSNP.base.vcf.gz #change batch as needed
DONOR_LIST=/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/batch3clean.txt #change from b1-b5
...
bcftools view $DONOR_VCF \
  -R $CELLSNP_VCF \
  -S $DONOR_LIST \
  -Oz -o $OUT_DIR/batch3_donors.sub.vcf.gz  #change here

module load tabix
# index for vireo
tabix -p vcf $OUT_DIR/batch3_donors.sub.vcf.gz # change here
