...
# Define variables
BASE_CELL_DIR="/share/hennlab/projects/NCR_scRNAseq/results/demultiplex/cellsnp/batch5"
BASE_OUT_DIR="/share/hennlab/projects/NCR_scRNAseq/results/demultiplex/vireo_batch_5"
n_donor=32


# List of sample IDs to process
############ edit all your sample IDs here#######################
SAMPLES=("TBSS17" "TBSS18" "TBSS19" "TBSS20") #  edit all your sample IDs here
################################################################################
