#!/bin/bash
#SBATCH --job-name=vireob2wgs #here
...
# Variables
BASE_CELL_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/cellsnp/batch2" #here
BASE_OUT_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/vireob2_with_WGS" #here
WGS_VCF="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/batch2_donors.sub.vcf.gz" #here
N_EXPECTED_DONORS=29 #here

mkdir -p "$BASE_OUT_DIR"

# Sample IDs
SAMPLES=("TBSS05" "TBSS06" "TBSS07" "TBSS08") #here
