#!/bin/bash
#SBATCH --job-name=vireob3wgs #here
...
# Variables
BASE_CELL_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/cellsnp/batch3" #here
BASE_OUT_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/vireob3_with_WGS" #here
WGS_VCF="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/batch3_donors.sub.vcf.gz" #here
N_EXPECTED_DONORS=27 #here

mkdir -p "$BASE_OUT_DIR"

# Sample IDs
SAMPLES=("TBSS09" "TBSS10" "TBSS11" "TBSS12") #here
