#!/bin/bash
#SBATCH --job-name=vireob5wgsv2 #here
...
# Variables
BASE_CELL_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/cellsnp/batch5" #here
BASE_OUT_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/vireob5-v2_with_WGS" #here
WGS_VCF="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/batch5_donors.sub.vcf.gz" #here
N_EXPECTED_DONORS=31 #here

mkdir -p "$BASE_OUT_DIR"

# Sample IDs
SAMPLES=("TBSS17" "TBSS18" "TBSS19" "TBSS20") #here
