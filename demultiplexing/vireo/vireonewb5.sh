#!/bin/bash
#SBATCH --job-name=vireob5wgs #here
...
BASE_OUT_DIR="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/vireob5_with_WGS" #here
WGS_VCF="/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/demultiplex/batch5_donors.sub.vcf.gz" #here
N_EXPECTED_DONORS=32 #here
