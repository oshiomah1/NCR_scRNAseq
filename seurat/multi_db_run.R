...
# --- 7 ScType databases (label -> path) ---
dbs <- list(
  baseline                     = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/ScTypeDB_immune_only.xlsx",
  no_isg                       = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg.xlsx",
  no_mega                      = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_mega.xlsx",
  no_isg_no_mega               = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg_no_mega.xlsx",
  no_isg_nktlikenegedit        = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg_nktlikenegedit.xlsx",
  no_isg_nktlikepozedit        = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg_nktlikepozedit.xlsx",
  no_isg_nktlikenegedit_nomega = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg_nktlikenegedit_nomega.xlsx",
  nktlikenegedit        = "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/data/no_isg_nktlikenegedit.xlsx"
)
