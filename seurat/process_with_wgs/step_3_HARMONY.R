...
log_file   <- "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/seurat/3_harmonize_batches_wgs/log_file_rawmerge_allres12_pca20.txt"
output_pdf <- "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/seurat/3_harmonize_batches_wgs/raw_merge_output_file_allres12_pca20.pdf"
save_rds   <- "/quobyte/bmhenngrp/from-lssc0/projects/NCR_scRNAseq/results/seurat/3_harmonize_batches_wgs/raw_merge_all_batches_harm_annotated_all_res12_pca20_noann.rds"
...
merged_obj <- FindNeighbors(merged_obj, reduction="harmony", dims=1:20, verbose=FALSE) %>%
